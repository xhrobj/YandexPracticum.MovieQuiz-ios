...
## Сдаём задачу спринта 7 на ревью (ветка sprint_07)

Поздравляем: вы завершили 7-й спринт. Пришло время для ревью!
Вам нужно сдать проект, в котором:
...
2. Написаны и проходят unit-тесты:
...
3. ведён рефакторинг проекта — отрефакторен MovieQuizViewController на архитектуру MVP по шагам из 3 и 4 уроков темы 5.
